...
// is partially covered today by the `node --check` syntax pass in CI (test-client.yml) which catches a
...
export default {
  ...
  coveredBy: "node --check of the chrome.* glue in .github/workflows/test-client.yml (a real-Chrome e2e is a tracked follow-up)",
};
